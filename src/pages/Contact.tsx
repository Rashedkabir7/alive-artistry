    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-santaran-cream/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div variants={fadeIn} className="text-center">
            ...
            >
              ...
              >
                <span className="mb-2">Scroll to Form</span>
                <motion.div
                  animate={{ 
                    y: [0, 10, 0],
                    transition: { 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="font-display text-xl font-medium text-santaran-teal mb-2">Email Us</h3>
              <p className="text-gray-600 mb-3">For general inquiries and information</p>
            ...
            >
              ...
              <h3 className="font-display text-xl font-medium text-santaran-teal mb-2">Call Us</h3>
              <p className="text-gray-600 mb-3">Monday to Friday, 9:00 AM - 5:00 PM</p>
            ...
            >
              ...
              <h3 className="font-display text-xl font-medium text-santaran-teal mb-2">Visit Us</h3>
              <p className="text-gray-600 mb-3">Our studio is open for visitors by appointment</p>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-santaran-cream/30 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="heading-md text-santaran-teal mb-4 font-serif">Find Our Studio</h2>
          ...
          >
            ...
            >
              <p className="text-gray-700">
                <span className="font-medium text-santaran-teal">Santaran Art Studio:</span> Located in the heart of Chittagong, 
                our space is a hub for artistic collaboration and cultural expression. 
                Feel free to schedule a visit to explore our gallery and ongoing projects.
              </p>
            </motion.div>
          </motion.div>
        </div>
