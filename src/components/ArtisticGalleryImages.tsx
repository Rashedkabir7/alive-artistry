...
const ArtisticGalleryImages: React.FC<ArtisticGalleryImagesProps> = ({ 
  ...
  const natureImages = [
    ...
    {
      src: "https://images.unsplash.com/photo-1506259091721-347e791bab0f?q=80&w=1200&auto=format&fit=crop",
      alt: "Nature-inspired art",
      caption: "Dharitri eco-tourism project: Ecological patterns in artistic design"
    },
    {
      src: "https://images.unsplash.com/photo-1517928260182-5687aefbd068?q=80&w=1200&auto=format&fit=crop",
  ...
  const folkImages = [
    {
      src: "https://images.unsplash.com/photo-1635048424329-a9bfb146d7aa?q=80&w=1200&auto=format&fit=crop",
    ...
    {
      src: "https://images.unsplash.com/photo-1569091791842-7cfb64e04797?q=80&w=1200&auto=format&fit=crop",
    ...
    {
      src: "https://images.unsplash.com/photo-1540360659536-a3f3ca9f7a78?q=80&w=1200&auto=format&fit=crop", 
  ...
  const childrenImages = [
    ...
    {
      src: "https://images.unsplash.com/photo-1560421683-6856ea585c78?q=80&w=1200&auto=format&fit=crop",
      alt: "Childhood creativity",
      caption: "Kalpapuri School of Arts & Crafts: Fostering artistic development in early years"
    },
    {
      src: "https://images.unsplash.com/photo-1529066516367-36973222c957?q=80&w=1200&auto=format&fit=crop",
  ...
  const contemporaryImages = [
    {
      src: "https://images.unsplash.com/photo-1541512416146-3e9ccaa35a9b?q=80&w=1200&auto=format&fit=crop",
      alt: "Contemporary art installation",
      caption: "Art Factory: Experimental contemporary expressions"
    },
    {
      src: "https://images.unsplash.com/photo-1576773689115-5cd2b0223523?q=80&w=1200&auto=format&fit=crop",
      alt: "Digital art projection",
      caption: "Young Art exhibition: Technology meets traditional art"
    },
    {
      src: "https://images.unsplash.com/photo-1567098228577-b7e7a3d98e28?q=80&w=1200&auto=format&fit=crop",
    ...
    {
      src: "https://images.unsplash.com/photo-1532453288509-177d8062a8ee?q=80&w=1200&auto=format&fit=crop",
